                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-8">
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="candidate.php" class="hover:text-primary transition-colors">Candidates</a></li>
                            <li><a href="blogs/index.php" class="hover:text-primary transition-colors">Updates</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="text-slate-900 dark:text-white font-bold mb-4 uppercase text-xs tracking-widest">Legal</h4>
                        <ul class="space-y-2">
                            <li><a href="privacy.php" class="hover:text-primary transition-colors">Privacy Policy</a></li>
                            <li><a href="terms.php" class="hover:text-primary transition-colors">Terms of Use</a></li>
                        </ul>
                    </div>
                </div>
            </div>
